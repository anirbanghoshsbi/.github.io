...
|---|---|
| Coding Agent | Prompt your agent (e.g., Cursor, Claude Code): "use brv curate to intelligently organize content from [filename]" |
 ...
 * Agentic Search: When querying, ByteRover doesn't just search for keywords; it reasons about the question, follows relationships between topics, and provides citations from the context.
